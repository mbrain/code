...
void PrintArpHeader (char* Buffer )
{
...
void PrintTcpPacket(char* Buffer, int Size)
{
    ...
    PrintData( Buffer + iphdrlen + tcpheader->data_offset + 15, Size - (tcpheader->data_offset + iphdrlen + 15) );
